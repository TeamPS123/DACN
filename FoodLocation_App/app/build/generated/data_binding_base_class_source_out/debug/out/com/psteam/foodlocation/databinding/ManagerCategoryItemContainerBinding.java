...
public final class ManagerCategoryItemContainerBinding implements ViewBinding {
  @NonNull
  ...
  private ManagerCategoryItemContainerBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialButton buttonDelete, @NonNull MaterialButton buttonEdit,
      @NonNull MaterialButton buttonStatus, @NonNull LinearLayout layout1,
  ...
  @NonNull
  public static ManagerCategoryItemContainerBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ManagerCategoryItemContainerBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.manager_category_item_container, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ManagerCategoryItemContainerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ManagerCategoryItemContainerBinding((ConstraintLayout) rootView, buttonDelete,
          buttonEdit, buttonStatus, layout1, textViewCategoryName);
    }
